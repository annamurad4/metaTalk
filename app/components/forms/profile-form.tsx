...
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Input, Select, SelectTrigger, SelectValue, SelectContent, SelectItem, Combobox, ComboboxTrigger, ComboboxInput, ComboboxContent, ComboboxItem, Avatar, Badge } from '@/components/ui'
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <Combobox
                      ...
                      onValueChange={(value) => setValue('learningLanguages', value as string[])}
                      multiple
                      maxSelections={5}
                      disabled={loading || isSubmitting}
                    >
                      <ComboboxTrigger>
                        <ComboboxInput placeholder="Dil ara..." />
                        <div className="ml-auto px-3 py-2 text-sm text-gray-600">
                          {watchedLearningLanguages.length > 0
                            ? `${watchedLearningLanguages.length} seçildi`
                            : 'Dil seçin...'}
                        </div>
                      </ComboboxTrigger>
                      <ComboboxContent>
                    ...
                    {errors.learningLanguages?.message && (
                      <p className="mt-1 text-xs text-red-600">{errors.learningLanguages.message}</p>
                    )}
                  ...
                  <div className="space-y-4">
                    <Combobox
                      ...
                      onValueChange={(value) => setValue('teachingLanguages', value as string[])}
                      multiple
                      maxSelections={5}
                      disabled={loading || isSubmitting}
                    >
                      <ComboboxTrigger>
                        ...
                        <div className="ml-auto px-3 py-2 text-sm text-gray-600">
                          {watchedTeachingLanguages.length > 0
                            ? `${watchedTeachingLanguages.length} seçildi`
                            : 'Dil seçin...'}
                        </div>
                      </ComboboxTrigger>
                      <ComboboxContent>
                    ...
                    {errors.teachingLanguages?.message && (
                      <p className="mt-1 text-xs text-red-600">{errors.teachingLanguages.message}</p>
                    )}
